...
public class Application {
	...
	public CommandLineRunner demo(CustomerRepository repository, CardRepository cardRepository) {
		return (args) -> {
			...
			log.info("Info ---- Customer with no of cards they own-------------------");
			 for (CustomerWithCardsCount cc : repository.findAllCustomersWithNoOfCardsHolding()) {
			 	log.info(cc.getFirstName() + " having " + cc.getNoOfcards() + " cards");
			 }
			log.info("");
		};
	}
